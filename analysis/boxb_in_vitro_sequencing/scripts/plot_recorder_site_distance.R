# Recorder sites and distances and supplementary concentrations; run from the repository root.
concentrations <- c("250nM", "125nM", "500nM")
output_names <- c("recorder_site_distance", "supp_recorder_positions_125nM",
...
for (panel in seq_along(concentrations)) {
  ...
  source("analysis/boxb_in_vitro_sequencing/scripts/recorder_site_distance_panel.R")
}
