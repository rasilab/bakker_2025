# Figure 2C: recorder positions split by distance and enzyme; run from repository root.
...
output_prefix <- paste0(analysis_directory, "/figures/fig2c_recorder_positions")
output_table <- paste0(analysis_directory, "/tables/fig2c_recorder_positions.csv")
